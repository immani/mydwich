                ...
                <table>
                    <thead>
                        <tr>
                            ...
                            <g:sortableColumn property="remark" title="${message(code: 'basket.remark.label', default: 'Remark')}" />
                    ...
                    <tbody>
                        <g:each in="${basketInstanceList}" status="i" var="basketInstance">
                            <tr class="${(i % 2) == 0 ? 'odd' : 'even'}">
                                <td><g:link action="show" id="${basketInstance.id}">${fieldValue(bean: basketInstance, field: "id")}</g:link></td>
                                <td>${fieldValue(bean: basketInstance, field: "remark")}</td>
