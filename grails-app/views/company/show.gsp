...
<html>
    ...
    <body>
        ...
        var map = displaymap(${fieldValue(bean: companyInstance, field: "lat")}, ${fieldValue(bean: companyInstance, field: "lng")}, '${fieldValue(bean: companyInstance, field: "name")}', contentString);
        displayrestaurantsnearcompany(map);
    </script>
    </body>
</html>
