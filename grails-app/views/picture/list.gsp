                            ...
                            <tr class="${(i % 2) == 0 ? 'odd' : 'even'}">
                                ...
                                <td>
                                    <g:link action="show" id="${pictureInstance.id}">
                                        <img width="50" height="50" src="${resource(dir:'restimages/' + pictureInstance?.restaurant.name.toLowerCase().encodeAsURL(), file:'thumb_'+ pictureInstance?.filename, absolute:'true')}" />
                                    </g:link>
                                </td>
