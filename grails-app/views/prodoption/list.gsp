...
<html>
    ...
    <body>
        <div class="nav">
            ...
            <span class="menuButton"><g:link class="list" controller="prodoptioncategory" action="show" id="${prodoptioncategoryInstance.id}">Back To Prod Option Category</g:link></span>
            <span class="menuButton"><g:link class="create" action="createprodoptionrestaurant"><g:message code="default.new.label" args="[entityName]" /></g:link></span>
        </div>
        <div class="body">
