                        ...
                        <tbody>
                            <tr class="prop">
                                ...
                                <td valign="top" class="value ${hasErrors(bean: prodOptionCategoryInstance, field: 'restaurant', 'errors')}">
                                    ${prodOptionCategoryInstance?.restaurant?.encodeAsHTML()}
                                    <g:hiddenField name="restaurant.id" value="${prodOptionCategoryInstance?.restaurant?.id}" />
                                </td>
                            </tr>
                            ...
                            <tr class="prop">
                             ...
                             <tr class="prop">
                                <td valign="top" class="name">
                                  <label for="productCategories"><g:message code="prodOptionCategory.productCategories.label" default="Product Categories" /></label>
                                </td>
                                <td valign="top" class="value ${hasErrors(bean: prodOptionCategoryInstance, field: 'productCategories', 'errors')}">
                                    <g:select name="productCategories" from="${prodCategoryList}" multiple="yes" optionKey="id" size="5" value="${prodOptionCategoryInstance?.productCategories*.id}" />
                                </td>
                            </tr>
