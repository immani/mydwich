                ...
                <table>
                    <thead>
                        <tr>
                            ...
                            <th><g:message code="prodOptionCategory.productCategories.label" default="Product Categories" /></th>
                            <th>Options</th>
                        </tr>
                    </thead>
                    ...
                    <tbody>
                        <g:each in="${prodOptionCategoryInstanceList}" status="i" var="prodOptionCategoryInstance">
                            <tr class="${(i % 2) == 0 ? 'odd' : 'even'}">
                                ...
                                <td><mydwich:disarrayploc instanceValue="${prodOptionCategoryInstance?.productCategories}" property="name"/></td>
