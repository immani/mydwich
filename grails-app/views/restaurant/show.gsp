...
<html>
    ...
    <body>
        <g:javascript src="easySlider1.7.js" />
        <div class="nav">
            <span class="menuButton"><a class="home" href="${createLink(uri: '/')}"><g:message code="default.home.label"/></a></span>
            <span class="menuButton"><g:link class="list" controller="picture" action="listrestaurantpictures"><g:message code="restaurant.pictures.list" args="[entityName]" /></g:link></span>
        </div>
        <div class="body">
                    ...
                    <div id="slider">
                        ...
                        <ul>
                            <g:each in="${pictureInstanceList}" var="pic">
                                ...
                                <li>
                                    <a name="${pic.filename}" title="${pic.filename}" href="${resource(dir:'restimages/' +pic.restaurant.name.toLowerCase().encodeAsURL(), file:pic.filename, absolute:'true')}">
                                        <img alt="${pic.caption}" src="${resource(dir:'restimages/' +pic.restaurant.name.toLowerCase().encodeAsURL(), file:'thumb_'+ pic.filename, absolute:'true')}" />
                                    </a>
                                </li>
                            </g:each>
                        </ul>
