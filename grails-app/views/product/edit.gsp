                        ...
                        <tbody>
                            ...
                            <tr class="prop">
                                ...
                                <td valign="top" class="value ${hasErrors(bean: productInstance, field: 'productCategories', 'errors')}">
                                    <g:select name="productCategories" from="${com.immani.mydwich.ProductCategory.list()}" multiple="yes" optionKey="id" size="5" value="${productInstance?.productCategories*.id}" />
                                </td>
                            </tr>
