    ...
    <body>
        ...
        <div id="pageBody">
            ...
            <div class="body">
                ...
                <div id="searchBox"> Instant Search: <g:remoteField name="searchBox" update="productlist" paramName="q" url="[controller:'anonymous_Product', action:'search']" /></div>
                ...
                <g:select name="productcategory" from="${productcategoriesInstanceList}" value="${productcategory?.id}" optionKey="id" noSelection="${['null':'']}"
                          onchange="${remoteFunction(controller:'anonymous_Product', action:'showproductlist', id:restaurantInstance.id, params:'\'productcategory=\' + this.value', update:'productlist')}"></g:select>
