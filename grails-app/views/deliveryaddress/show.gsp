            ...
            <div class="dialog">
                <table>
                    <tbody>
                        ...
                        <tr class="prop">
                            <td valign="top" class="name"><g:message code="deliveryAddress.id.label" default="Id" /></td>
                            
                            <td valign="top" class="value">${fieldValue(bean: deliveryAddressInstance, field: "id")}</td>
                        ...
                        <tr class="prop">
                            ...
                            <td valign="top" class="value"><g:link controller="company" action="show" id="${deliveryAddressInstance?.company?.id}">${deliveryAddressInstance?.company?.encodeAsHTML()}</g:link></td>
